...
import { Equipment, Category, CreateExerciseDTO, Exercise, ExerciseBasic } from "@/types/exercise";
...
export default function CreateExerciseForm() {
  ...
  const handleArrayAdd = (
    field: keyof Pick<CreateExerciseDTO, "alternative_names" | "video_links">
  ) => {
    setFormData((prev) => ({
      ...prev,
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {formData.alternative_names.map((name, index) => (
          <div key={index} className="flex gap-2 mb-2">
            <input
              ...
              value={name}
              onChange={(e) =>
                handleArrayChange("alternative_names", index, e.target.value)
              }
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) =>
            setFormData((prev) => ({ ...prev, detailed_steps: e.target.value }))
          }
          className="mt-1 w-full p-2 border rounded-md"
          rows={6}
          disabled={loading}
      ...
      <div>
        ...
        <textarea
          ...
          onChange={(e) =>
            setFormData((prev) => ({ ...prev, execution_tips: e.target.value }))
          }
          className="mt-1 w-full p-2 border rounded-md"
          rows={4}
          disabled={loading}
          ...
          {formData.alternative_equipment_ids.map((equipmentId, index) => (
            <div key={index} className="flex gap-2">
              ...
              <button
                ...
                onClick={() => {
                  const newEquipment =
                    formData.alternative_equipment_ids.filter(
                      (_, i) => i !== index
                    );
                  setFormData((prev) => ({
                    ...prev,
          ...
          <button
            ...
            onClick={() => {
              setFormData((prev) => ({
                ...prev,
                alternative_equipment_ids: [
                  ...prev.alternative_equipment_ids,
                  "",
                ],
              }));
            }}
          ...
          <div className="flex gap-2">
            <input
              ...
              onChange={(e) =>
                setFormData((prev) => ({
                  ...prev,
                  series_min: parseInt(e.target.value),
                }))
              }
              className="mt-1 w-full p-2 border rounded-md"
              min="1"
            ...
            <input
              ...
              onChange={(e) =>
                setFormData((prev) => ({
                  ...prev,
                  series_max: parseInt(e.target.value),
                }))
              }
              className="mt-1 w-full p-2 border rounded-md"
          ...
          <div className="flex gap-2">
            <input
              ...
              onChange={(e) =>
                setFormData((prev) => ({
                  ...prev,
                  reps_min: parseInt(e.target.value),
                }))
              }
              className="mt-1 w-full p-2 border rounded-md"
              min="1"
            ...
            <input
              ...
              onChange={(e) =>
                setFormData((prev) => ({
                  ...prev,
                  reps_max: parseInt(e.target.value),
                }))
              }
              className="mt-1 w-full p-2 border rounded-md"
          ...
          <div className="flex gap-2">
            <input
              ...
              onChange={(e) =>
                setFormData((prev) => ({
                  ...prev,
                  rir_min: parseInt(e.target.value),
                }))
              }
              className="mt-1 w-full p-2 border rounded-md"
              min="0"
            ...
            <input
              ...
              onChange={(e) =>
                setFormData((prev) => ({
                  ...prev,
                  rir_max: parseInt(e.target.value),
                }))
              }
              className="mt-1 w-full p-2 border rounded-md"
          ...
          <div className="flex gap-2">
            <input
              ...
              onChange={(e) =>
                setFormData((prev) => ({
                  ...prev,
                  rpe_min: parseInt(e.target.value),
                }))
              }
              className="mt-1 w-full p-2 border rounded-md"
              min="5"
            ...
            <input
              ...
              onChange={(e) =>
                setFormData((prev) => ({
                  ...prev,
                  rpe_max: parseInt(e.target.value),
                }))
              }
              className="mt-1 w-full p-2 border rounded-md"
        ...
        {formData.video_links.map((link, index) => (
          <div key={index} className="flex gap-2 mb-2">
            <input
              ...
              value={link}
              onChange={(e) =>
                handleArrayChange("video_links", index, e.target.value)
              }
              className="flex-1 p-2 border rounded-md"
              placeholder="https://..."
              disabled={loading}
